...
Infer the repository from `git remote -v`; `gh` does this automatically when run inside a clone. A GitHub remote must be configured before these operations can be used.
